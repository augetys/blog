package com.hope.blog.monitor.ServerInfo;

import com.hope.blog.utils.Arith;
...
public class ServerInfo {
    ...
    private void setJvmInfo() throws UnknownHostException {
        ...
        jvm.setStartTime(DateUtil.format(DateUtil.getServerStartDate(), DateUtil.DATE_FORMAT_SECOND));
        jvm.setRunTime(DateUtil.getDatePoor(DateUtil.getNowDate(), DateUtil.getServerStartDate()));
